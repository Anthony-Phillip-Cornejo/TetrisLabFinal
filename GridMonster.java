...
public class GridMonster
{
	...
	private static void gridTests1()
	{
		...
		if (!GRID0.isValid(new Location(0, 0)))
			throw new RuntimeException("isValid is dumb1.");
		if (!GRID0.isValid(new Location(0, 1)))
			throw new RuntimeException("isValid is dumb2.");
		if (GRID0.isValid(new Location(0, 2)))
			throw new RuntimeException("isValid is dumb3.");
		if (GRID0.isValid(new Location(1, 0)))
			throw new RuntimeException("isValid is dumb4.");
		if (GRID0.isValid(new Location(0, -1)))
			throw new RuntimeException("isValid is dumb5.");
		if (GRID0.isValid(new Location(-1, 0)))
			throw new RuntimeException("isValid is dumb6.");

		final BoundedGrid<String> GRID1 = new BoundedGrid<String>(2, 1);

		if (! GRID1.isValid(new Location(0, 0)))
			throw new RuntimeException("isValid is dumb7.");
		if (! GRID1.isValid(new Location(1, 0)))
			throw new RuntimeException("isValid is dumb8.");
		if (GRID1.isValid(new Location(2, 0)))
			throw new RuntimeException("isValid is dumb9.");
		if (GRID1.isValid(new Location(0, 1)))
			throw new RuntimeException("isValid is dumb10.");
